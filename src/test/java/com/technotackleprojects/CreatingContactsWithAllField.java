...
public class CreatingContactsWithAllField {
		...
		public void enterAllValidFields() {
		    ...
		    txtLinkedin.sendKeys("https://www.linkedin.com/");
		...
		public void TakesScreensho() throws IOException {
			...
			File destination = new File("C:\\Users\\User\\eclipse-workspaceFW\\TechnoTackle_CC_Balaji\\target\\Screenshots\\Technoform.png");
